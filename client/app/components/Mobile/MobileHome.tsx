...
function MobileHome({mobileCheck} : any) {
    ...
    return (
        <div className='flex flex-col items-center justify-center h-full w-full p-4'>
            ...
            <br />
            <button className="w-40 bg-blue-600 hover:bg-blue-700 rounded-lg mr-1 h-12 text-white transition-colors duration-900" onClick={keyboardHandler}>Keyboard</button>
        </div>
    )
}
